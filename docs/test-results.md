...
| TC-12 | IT-PC-01 | SSH to SW-ACCESS-01 | Allowed | The IT client authenticated through SSH version 2, entered user EXEC mode, and elevated to privileged EXEC using a separate enable secret | Pass | [View evidence](../screenshots/tc-12-it-ssh-allowed.png) |
